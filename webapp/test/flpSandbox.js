		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#trainingoncapmui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"trainingoncapmui5-display": {
								"semanticObject": "trainingoncapmui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=trainingoncapmui5",
									"url": sap.ui.require.toUrl("trainingoncapmui5")
								}
							}
						}
					}
